...
class Clouds : GameObjectList
{
        ...
        : base(layer, id)
    {
        for (int i = 0; i < 3; i++)
        {
            ...
            cloud.Position = new Vector2((float)GameEnvironment.Random.NextDouble() * 3000 - cloud.Width / 2, (float)GameEnvironment.Random.NextDouble() * GameEnvironment.Screen.Y - cloud.Height / 2);
